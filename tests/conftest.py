...
"""
    Module containing PyTest fixtures. Fixtures are reusable pieces of code that can be used in tests for steps which
    happen repeatedly
"""
...
def app():
    """
        A fixture which creates an instance of the application in testing mode and fills the database with the test
...
class AuthActions(object):
    ...
    def login(self, username='testAdmin', password='test'):
    ...
    def logout(self):
        # log the user out
        return self._client.get('/quiz-manager/logout')
